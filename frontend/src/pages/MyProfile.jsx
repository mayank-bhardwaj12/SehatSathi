...
const MyProfile = () => {
  const [userData,setUserData]=useState({
    ...
    email:"bhardwajmayank058@gmail.com",
    phone:'9999999999',
    address:{
      line1:"Rohtak,Haryana",
      line2:"India"
    },
    gender:"Male",
    dob:'2005-10-28'
    ...
    <div>
      ...
      <div className='grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-neutral-700'>
        ...
        <p className='font-medium'>Phone:</p>
         {
      isEdit?<input className='bg-gray-100 max-w-52' type='text' value={userData.phone} onChange={e=>setUserData(prev=>({...prev,phone:e.target.value}))}/>:<p className='text-green-400'>{userData.phone}</p>
    }
